This subdirectory contains the Homework 6 assignment for the IR tracker using the stepper motor that we checked out from the ECE parts room. To operate our code, simply do the following:
